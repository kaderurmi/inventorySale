    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="header01">
            <ul class="navbar-nav ms-auto mt-3 mt-lg-0 mb-3 mb-lg-0 me-4">
                ...
                <li class="nav-item me-4"><a class="nav-link" href="{{url('/company')}}">Company</a></li>
                <li class="nav-item me-4"><a class="nav-link" href="{{url('/service')}}">Services</a></li>
                <li class="nav-item"><a class="nav-link" href="{{url('/testimonial')}}">Testimonials</a></li>
            </ul>
