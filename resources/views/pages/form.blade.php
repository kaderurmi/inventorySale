    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-lg-5 mb-5 mb-lg-0">
                ...
                <p class="text-muted mb-5">Insuf Foods, bakolia, Chittagong, Bangladesh.</p>
                <h4 class="fw-bold">Contact Us</h4>
                <p class="text-muted mb-1">kaderurmi@gmail.com</p>
                <p class="text-muted mb-0">+8801678054692</p>
            </div>
